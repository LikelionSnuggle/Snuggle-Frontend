    ...
    <div className={`w-full h-100vh bg-white font-['IBM-Plex-Sans']`}>
      ...
      <div className={`w-full h-[460px]`}>
        <img
          ...
          src={PerformThumbnail}
          alt="PerformThumbnail"
        />
      </div>
      {/* 안산의 HOT 스테이지 */}
      <div
        className={`flex flex-row mt-[16px] px-[16px] w-full h-fit justify-between items-center`}
      >
        <p className={`font-semibold text-2xl`}>안산의 HOT 스테이지</p>
        <Link to="/nearperform" className={`font-semibold text-zinc-300`}>
          모두보기
        </Link>
      </div>
      {/* 무대들 */}
      ...
      >
        ...
        <Link to="/newperform" className={`font-semibold text-zinc-300`}>
          모두보기
        </Link>
      </div>
      {/* 무대들 */}
